...
|------|-------------|------|---------|:--------:|
| <a name="input_api_server_extra_args"></a> [api\_server\_extra\_args](#input\_api\_server\_extra\_args) | n/a | `map(string)` | `{}` | no |
...
| <a name="input_controller_manager_extra_args"></a> [controller\_manager\_extra\_args](#input\_controller\_manager\_extra\_args) | n/a | `map(string)` | `{}` | no |
...
| <a name="input_etcd_extra_args"></a> [etcd\_extra\_args](#input\_etcd\_extra\_args) | n/a | `map(string)` | `{}` | no |
...
| <a name="input_scheduler_extra_args"></a> [scheduler\_extra\_args](#input\_scheduler\_extra\_args) | n/a | `map(string)` | `{}` | no |
